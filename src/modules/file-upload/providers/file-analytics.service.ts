...
import { type FileAnalytics, AnalyticsEvent } from "../entities/file-analytics.entity"
...
export class FileAnalyticsService {
  ...
  async getAnalyticsReport(userId: string, startDate: Date, endDate: Date): Promise<AnalyticsReport> {
    // Get user's files
